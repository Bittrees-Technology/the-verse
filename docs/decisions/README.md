...
| ADR | Decision | Status |
| --- | --- | --- |
| [0001](ADR-0001-open-source-stack.md) | Open-source engine and service baseline | Accepted |
...
| [0015](ADR-0015-session-bound-multiplayer-cell.md) | Session-bound actors and deterministic multi-player cell state | Accepted |
...
| [0031](ADR-0031-leaf-contacts-and-supported-prediction.md) | Exact leaf contacts and supported movement prediction | Accepted |
